...
| Calvert-Lewin | FWD | LEE | 6.0 | 22.3 | 10 | 252 | 1.67 | 0.333 | 8.0 / 1.0 | 1-2-0 | NEW (H, 2) |
...
(Read: all 15 slots; Calvert-Lewin (bench) confirmed 12 Sep. Difficulty 1-5, FPL rating.)
...
- **Bench watch: Calvert-Lewin** (1.67 ppm, 0.333 consistency, home-heavy 8.0/1.0 split - descriptive only). Leeds host Newcastle (difficulty 2), but the dials say he stays bench depth, not a start candidate.
